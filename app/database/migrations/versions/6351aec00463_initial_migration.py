...
Revision ID: 6351aec00463
Revises: 
Create Date: 2026-03-20 15:45:01.958091
...
def upgrade() -> None:
    ...
    op.create_table('users_telegram_channels',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('channel_id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['channel_id'], ['telegram_channels.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('clusters_news')
    op.drop_table('query_history')
    op.drop_table('favorite_digests')
    op.drop_table('clusters')
    op.drop_table('users_telegram_channels')
